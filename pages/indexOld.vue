    ...
    >
      ...
      >
        ...
        <div class="w-full sm:w-6/12 flex justify-end p-6 sm:p-0">
          <img loading="lazy" src="~/assets/images/1.jpg" alt="" class="w-auto rounded-lg animate-pulse">
          <img loading="lazy" src="~/assets/images/2.jpg" alt="" class="w-auto rounded-lg animate-pulse">
